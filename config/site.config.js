...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'li49696@t.5tb.in',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/KanoYK/onedrive-vercel-index',
    },
    {
      name: 'Telegram',
      link: '',
